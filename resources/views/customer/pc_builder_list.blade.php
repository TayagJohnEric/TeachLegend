                        ...
                        <div class="p-5">
                            ...
                            <div class="space-y-2 mb-4">
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-medium">${{ number_format($pcBuild->budget, 2) }}</span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-600">Total Cost:</span>
                                    <span class="font-medium">${{ number_format($pcBuild->total_cost, 2) }}</span>
                                </div>
                                <div class="flex justify-between text-sm">
                            ...
                            <div class="flex space-x-2 pt-3 border-t border-gray-100">
                                ...
                                <form action="{{ route('pc-builder.destroy', $pcBuild->id) }}" method="POST" class="flex-none" onsubmit="return confirm('Are you sure you want to delete this build?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="bg-gray-50 text-gray-700 px-3 py-2 rounded-md hover:bg-gray-100 transition duration-200">
