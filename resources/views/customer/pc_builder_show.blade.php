        ...
        <div class="p-6">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-gray-200">
                <div class="flex gap-2">
                    <form action="{{ route('pc-builder.destroy', $pcBuild->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="flex items-center px-4 py-3 font-medium text-sm text-gray-500 rounded-lg bg-gray-50 hover:bg-gray-100 transition">
