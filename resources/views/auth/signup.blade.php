...
<body class=" min-h-screen font-sans flex flex-col items-center justify-center p-4" style="font-family: 'Inter', sans-serif;">
    ...
    <div class="bg-white p-8  w-full max-w-md">
        ...
        <h1 class="text-xl font-bold text-center text-gray-800">Sign up</h1>
        <p class="text-sm text-gray-400 mb-6 text-center">
            Create your account to explore exclusive deals, track your orders, and enjoy a seamless shopping experience.
        </p>

        <form action="{{ route('register') }}" method="POST" class="space-y-6 mt-10">
            @csrf
...
@endif
            ...
            <div>
                ...
                <input type="email" id="email" name="email" required placeholder="johndoe69@example.com"
                    class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="password_confirmation" name="password_confirmation" required 
                        class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <button type="button" class="password-toggle absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none" data-target="password_confirmation">
                        <i data-feather="eye"></i>
                    </button>
                </div>
            </div>
